...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image17": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/topRightArrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Testimonial-modified.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image35": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/rightNavArrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox97": {
      "custom": {
        "text": "What is a typical timeline for a project?"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image52": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/rightArrowWhite.svg"
      },
      "callbacks": {
        "onClick": [
          {
